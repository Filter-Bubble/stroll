...
def contrastive_loss(links, similarities, tau=torch.tensor(0.7)):
    ...
    https://arxiv.org/abs/2004.11362
        links     torch.Tenser([nmentions, nmentions]) containing
                  1 when the mentions are linked (in the same cluster) or
                  0 when not.
        similarities  torch.Tensor([nmentions, nmentions]) the pairwise
                      similarity between mention a and b.
        tau           torch.Tensor([0.7]) temperature constant in the loss
